...
-- (Insertar datos mediante importacion de archivo MOCK_DATA_(registros_insercion).csv) ya sea
-- mediante el siguiente codigo o mediante el asistente de importacion de MySQL Workbench
LOAD DATA LOCAL INFILE 'MOCK_DATA_(registros_insercion).csv'
INTO TABLE usuario
...
# Parte 4: CREACION DE FUNCIONES

-- Funcion STOCK_GENERO
DELIMITER $$
...
# Parte 5: CREACION DE STORED PROCEDURES
